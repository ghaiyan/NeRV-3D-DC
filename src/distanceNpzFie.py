...
def contactToDist(hicfilename,hicfiledir,alpha,distfileDir):
    """Convert contact matrix of npz file format to distance matrix."""
    contactMat=np.load(hicfiledir)
    contactMat=contactMat['hic']
...
hicfilename="chr22_1000b"
hicfiledir="/data2/ghy_data/ghy_data/1kb/GM12878/chr22_1000b.npz"
alpha=0.4
distfileDir="/data2/ghy_data/ghy_data/1kb/GM12878/NeRV-3D-DC/chr22/0.4/900"
contactToDist(hicfilename,hicfiledir,alpha,distfileDir)